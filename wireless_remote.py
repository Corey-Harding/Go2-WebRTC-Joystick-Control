...
async def main():
    ...
    KEY_R1 =     0b0000000000000001
    KEY_L1 =     0b0000000000000010
    KEY_START =  0b0000000000000100
    KEY_SELECT = 0b0000000000001000
    KEY_R2 =     0b0000000000010000
    KEY_L2 =     0b0000000000100000
    KEY_F1 =     0b0000000001000000
    KEY_F3 =     0b0000000010000000
    KEY_A =      0b0000000100000000
    KEY_B =      0b0000001000000000
    KEY_X =      0b0000010000000000
    KEY_Y =      0b0000100000000000
    KEY_UP =     0b0001000000000000
    KEY_RIGHT =  0b0010000000000000
    KEY_DOWN =   0b0100000000000000
    KEY_LEFT =   0b1000000000000000
    ...
    while run:
        ...
        if (abs(Lx) > DEADZONE or abs(Ly) > DEADZONE or abs(Rx) > DEADZONE):
            try:
                print(f"Sending command( lx: {Lx}, ly: {Ly}, rx: {Rx}, ry: {Ry}, keys: 4 )")
                ...
                RTC_TOPIC["WIRELESS_CONTROLLER"],
                {
                    ...
                    "rx": Rx,
                    "ry": Ry,
                    "keys": 4 #Sending unlock on move command
                }
                ),
                timeout=.1
                )
